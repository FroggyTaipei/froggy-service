# Generated by Django 2.1.5 on 2019-01-08 06:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', django_fsm.FSMField(choices=[('draft', 'Draft'), ('published', 'Published'), ('republished', 'Republished')], default='draft', max_length=50, verbose_name='Arrange State')),
