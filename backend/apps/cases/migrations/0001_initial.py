    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile', phonenumber_field.modelfields.PhoneNumberField(blank=True, max_length=128, null=True, verbose_name='Mobile')),
        ...
        migrations.AddField(
            model_name='case',
            name='tags',
            field=tagulous.models.fields.TagField(_set_tag_meta=True, help_text='Enter a comma-separated tag string', to='cases.Tagulous_Case_tags', verbose_name='Case Tags'),
        ),
        migrations.AddField(
            model_name='case',
            name='type',
