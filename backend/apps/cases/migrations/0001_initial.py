# Generated by Django 2.1.5 on 2019-01-19 16:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('close_info', models.TextField(blank=True, null=True, verbose_name='Close Info')),
            ],
            options={
                'verbose_name': 'Case',
        ...
        migrations.AddField(
            model_name='case',
            name='tags',
            field=tagulous.models.fields.TagField(_set_tag_meta=True, help_text='Enter a comma-separated tag string', to='cases.Tagulous_Case_tags', verbose_name='Tags'),
        ),
        migrations.AddField(
            model_name='case',
            name='type',
