# Generated by Django 2.1.5 on 2019-01-08 06:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', django_fsm.FSMField(choices=[('draft', 'Draft'), ('disapproved', 'Disapproved'), ('approved', 'Approved'), ('arranged', 'Arranged'), ('closed', 'Closed')], default='draft', max_length=50, verbose_name='Case State')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('state', django_fsm.FSMField(choices=[('draft', 'Draft'), ('disapproved', 'Disapproved'), ('approved', 'Approved'), ('arranged', 'Arranged'), ('closed', 'Closed')], default='draft', max_length=50, protected=True, verbose_name='Case State')),
                ('number', models.CharField(max_length=6, verbose_name='Case Number')),
                ('title', models.CharField(max_length=255, verbose_name='Case Title')),
                ('content', models.TextField(verbose_name='Content')),
                ('location', models.CharField(max_length=255, verbose_name='Location')),
